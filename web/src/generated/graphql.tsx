	...
	reviewsByUserId: Array<{
		...
		listing?: Maybe<{
			...
			host?: Maybe<{
				...
				dateJoined: string;
				listings: Array<
					Maybe<{ __typename?: "Listing"; city: string }>
				>;
			}>;
		}>;
	}>;
 ...
 * });
 */
export function useReviewsByUserIdQuery(
	baseOptions: Apollo.QueryHookOptions<
		ReviewsByUserIdQuery,
		ReviewsByUserIdQueryVariables
	>
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<ReviewsByUserIdQuery, ReviewsByUserIdQueryVariables>(
		ReviewsByUserIdDocument,
		options
	);
}
export function useReviewsByUserIdLazyQuery(
	...
	return Apollo.useLazyQuery<
		ReviewsByUserIdQuery,
		ReviewsByUserIdQueryVariables
	>(ReviewsByUserIdDocument, options);
}
export type ReviewsByUserIdQueryHookResult = ReturnType<
	typeof useReviewsByUserIdQuery
>;
export type ReviewsByUserIdLazyQueryHookResult = ReturnType<
	typeof useReviewsByUserIdLazyQuery
>;
export type ReviewsByUserIdQueryResult = Apollo.QueryResult<
	ReviewsByUserIdQuery,
	ReviewsByUserIdQueryVariables
>;
